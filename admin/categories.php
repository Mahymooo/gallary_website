                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="deletecategory.php?id=<?php echo $id; ?>" onclick="return confirm('Are you sure you want to delete this user?')"><img src="images/delete.png" alt="delete"></a></td>
                        </tr>
                        <?php
                        }
                        ?>
