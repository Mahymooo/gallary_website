<?php
	...
	try{
		$sql="INSERT INTO `users`( `full_name`, `user_name`, `email`, `active`, `password`) VALUES (?,?,?,?,?)";
		...
		$stmt->execute([$full_name, $user_name, $email, $active, $password]);
								...
								<div class="x_content">
									...
									<form action="" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name"  required="required" class="form-control" name="user_name" >
											</div>
										</div>
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<input id="email" class="form-control" type="email" required="required" name="email" >
											</div>
										</div>
										<div class="item form-group">
